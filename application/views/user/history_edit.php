...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Hallo <?php echo $this->session->userdata('nama'); ?></h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <h4 class="card-title">Base Class</h4>
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo base_url('user/history_edit/deleteclass/'.$p['id_class'].'/'.$id) ?>">
                            <input type="hidden" id="id_solid" name="id_solid" value="<?php echo $id; ?>">
                            <button class="btn btn-danger m-b-10" type="button" id="id_class" onclick=""><i class="fa fa-trash"></i> Hapus</button>
                        </a>    
                    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                <h4 class="card-title">Sub Kelas</h4>
                    <?php foreach ($subclass as $p): ?>
                    <div class="col-md-12">
                        <button class="btn btn-info m-b-10" type="button" style="cursor: default;" ><i class="fa fa-table"></i> <?php echo $p['class_induk']; ?></button> <i class="fa fa-arrow-right"></i>
                        ...
                        <a href="<?php echo base_url('user/history_edit/deleteclass/'.$p['id_class'].'/'.$id) ?>">
                            <input type="hidden" id="id_solid" name="id_solid" value="<?php echo $id; ?>">
                            <button class="btn btn-danger m-b-10" type="button" id="tbl_class" onclick=""><i class="fa fa-trash"></i> Hapus</button>
                        </a>
                    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formclass" method="post" action="<?php echo base_url('user/history_edit/addclass') ?>">
                    <input type="hidden" id="id_solid" name="id_solid" value="<?php echo $id; ?>">
                    <input type="hidden" id="id_users" name="id_users" value="<?php echo $this->session->userdata('id'); ?>">
                        ...
                        <div id="div_subclass" class=""></div>
                            <button id="btnsubmitclass" class="btn btn-block btn-success" type="submit" onclick="" hidden> Kirim Data Base Class</button>
                            <button id="btnsubmitsubclass" class="btn btn-block btn-success" type="submit" onclick="" hidden> Kirim Data Sub Class</button>
                        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Cek Diagram Kelas : SOLID <b id="myidsolid"><?php echo $id;?></b></h4>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header d-flex align-items-center">
                        <h4 class="modal-title" id="fieldclasslabel">Data</h4>
        ...
        <div class="modal fade" id="subclass-modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header d-flex align-items-center">
                        <h4 class="modal-title" id="fieldsubclasslabel">Data</h4>
                        <button type="button" class="close ml-auto" data-dismiss="modal"
                            aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
...
function ocp() {
    ...
    $('#div_ocp').append('<div class="col-md-6"><table id="ocptable" class="table table-hover"><thead class="bg-primary text-white"><tr><th>Nama Kelas</th><th>NOC</th><th>Status Kelas</th><th>OCP/Tidak</th></tr></thead><tbody id="bodyocp"></tbody></table></div>')
...
function srp() {
    ...
    $.getJSON('/solid/user/history_edit/getclassinfo/'+myidsolid+'/class',function(data){
        console.log(data);
...
function div_subclass() {
    ...
    $.getJSON('/solid/user/history_edit/checkexistclass/'+idsolid,function(data){
        if(data != 'empty') {
...
function addmethodsubclass(id) {
    ...
    $('.classind'+roommethodsubclass).change(function(e){
        ...
        $.getJSON('/solid/user/history_edit/checkmethod/'+valci,function(cmdata){
    ...
    $('.smethod'+roommethodsubclass).change(function(e){
        ...
        $.getJSON('/solid/user/history_edit/checkparam/'+valmet,function(cpdata){
