            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="waves-effect waves-dark" href="<?php echo base_url('user/dashboard') ?>" aria-expanded="false"><i class="fa fa-home"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                       

                            <li>
                                <a class="waves-effect waves-dark" href="<?php echo base_url('user/history') ?>" aria-expanded="false"><i class="fa fa-history"></i><span class="hide-menu">History</span></a>
                            </li>
                            <li>
