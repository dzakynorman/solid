    ...
    <section id="wrapper">
        ...
        <div class="login-register" style="background-image:url(<?php echo base_url() ?>assets/images/background/bg-1.jpg);">        
            ...
            <div class="card-body">
                ...
                <?php if (isset($msg)): ?>
                <div class="alert alert-success hide_msg pull" style="width: 100%"> <i class="fa fa-check-circle"></i> <?php echo $msg; ?> &nbsp;
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                </div>
            <?php endif ?>
                    <!-- Form Login -->
                <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('auth/log'); ?>" method="post">
                    <h2 class="box-title m-b-40 text-center text-white">Login <img src="<?php echo base_url() ?>assets/images/logo-univ.png" height="70" width="150"></h2>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control text-white" type="text" name="user_name" required="" placeholder="Email" autocomplete="off" readonly 
                                onfocus="this.removeAttribute('readonly');"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control text-white" type="password" name="password" required="" placeholder="Password" autocomplete="off" readonly 
                    ...
                    <div class="form-group text-center m-t-50">
                        <div class="col-xs-12">
                            <button class="btn btn-success btn-block text-uppercase waves-effect waves-light" style="background: #647244 !important;" type="submit">Login</button>
                        </div>
                    </div>
                    <!-- Register -->
