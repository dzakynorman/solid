...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('user/history_edit/edit'.$field->id_solid) ?>">Home</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('user/history_edit/updateField/'.$field->id_field) ?>" class="form-horizontal" novalidate>
                        <div class="form-body">
                            <br>
                                ...
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="controls">
                                            ...
                                            <a href="<?php echo base_url('user/history_edit/edit/'.$field->id_solid) ?>" class="btn btn-danger">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
