...
class Dashboard extends CI_Controller {
    ...
    public function index(){
        $id_solid = $this->session->userdata('id_solid');
        // echo $id_solid;
        $data = array();
        $data['page_title'] = 'Dashboard';
        $data['class'] = $this->common_model->select_class($id_solid,'tbl_class');
        $data['subclass'] = $this->common_model->select_subclass($id_solid,'tbl_class');
    ...
    public function addclass() {
        // if ($_POST) {
            ...
            // $this->session->set_flashdata('msg', $name_class);
            // redirect(base_url('user/dashboard/index'));
        // }
    }
    ...
    public function updateMethod($id) {
        if ($_POST) {
            ...
            $data['main_content'] = $this->load->view('edit-method', $data, TRUE);
            $this->load->view('user/index', $data);
    }
    ...
    public function updateField($id) {
        if ($_POST) {
            ...
            $data['main_content'] = $this->load->view('edit-field', $data, TRUE);
            $this->load->view('user/index', $data);
    }
