...
0,d("seconds"),this.s.secondsRange)},_show:function(){var a=this,b=this.s.namespace;this._position();d(q).on("scroll."+b+" resize."+b,function(){a._hide()});d("div.DTE_Body_Content").on("scroll."+b,function(){a._hide()});d("div.dataTables_scrollBody").on("scroll."+b,function(){a._hide()});d(r).on("keydown."+b,function(b){9!==b.keyCode&&27!==b.keyCode&&13!==b.keyCode||a._hide()});setTimeout(function(){d("body").on("click."+b,function(b){d(b.target).parents().filter(a.dom.container).length||b.target===
a.dom.input[0]||a._hide()})},10)},_writeOutput:function(a){var b=this.s.d,c=q.moment?q.moment.utc(b,l,this.c.momentLocale,this.c.momentStrict).format(this.c.format):b.getUTCFullYear()+"-"+this._pad(b.getUTCMonth()+1)+"-"+this._pad(b.getUTCDate());this.dom.input.val(c).trigger("change",{write:b});a&&this.dom.input.focus()}});f.DateTime._instance=0;f.DateTime.defaults={classPrefix:"editor-datetime",disableDays:null,firstDay:1,format:"YYYY-MM-DD",hoursAvailable:null,i18n:f.defaults.i18n.datetime,maxDate:null,
minDate:null,minutesAvailable:null,minutesIncrement:1,momentStrict:!0,momentLocale:"en",onChange:function(){},secondsAvailable:null,secondsIncrement:1,showWeekNumber:!1,yearRange:25};(function(){function a(a,b){if(null===b||b===l)b=a.uploadText||"Choose file...";a._input.find("div.upload button").html(b)}function b(b,c,e,k){var g=b.classes.form.buttonInternal,h=d('<div class="editor_upload"><div class="eu_table"><div class="row"><div class="cell upload limitHide"><button class="'+g+'"></button><input type="file" '+
(k?"multiple":"")+'></input></div><div class="cell clearValue"><button class="'+g+'"></button></div></div><div class="row second"><div class="cell limitHide"><div class="drop"><span></span></div></div><div class="cell"><div class="rendered"></div></div></div></div></div>');c._input=h;c._enabled=!0;c.id&&h.find("input[type=file]").attr("id",f.safeId(c.id));c.attr&&h.find("input[type=file]").attr(c.attr);a(c);if(q.FileReader&&!1!==c.dragDrop){h.find("div.drop span").text(c.dragDropText||"Drag and drop a file here to upload");
...
h.find("div.clearValue button").on("click",function(a){a.preventDefault();c._enabled&&f.fieldTypes.upload.set.call(b,c,"")});h.find("input[type=file]").on("input",function(){f.upload(b,c,this.files,a,function(a){e.call(b,a);h.find("input[type=file]")[0].value=null})});return h}function c(a){setTimeout(function(){a.trigger("change",{editor:!0,editorSet:!0})},0)}var e=f.fieldTypes,k=d.extend(!0,{},f.models.fieldType,{get:function(a){return a._input.val()},set:function(a,b){a._input.val(b);c(a._input)},
